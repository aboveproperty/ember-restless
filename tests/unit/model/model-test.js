...
import {attr, hasMany, belongsTo, Model} from 'ember-restless';
...
module('Unit | Model | model', {
    beforeEach(){
        run(function () {
            ...
            ClientAddress = Model.extend({}).reopenClass({
        ...
        application.register('model:tag', Tag);
        application.register('model:post', Post);
